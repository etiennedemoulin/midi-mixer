...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 184.5, 303.5, 117.0, 22.0 ],
					"presentation_linecount" : 2,
					"text" : "script node --version"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 399.5, 289.0, 923.0, 396.0 ],
					"viewvisibility" : 1
				}
...
,
					"text" : "node.script max.cjs @autostart 1"
				}
...
, 			{
				"name" : "max.cjs",
				"bootpath" : "~/work/dev/libs/soap/midi-mixer/example",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
